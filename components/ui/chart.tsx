...
export function ChartContainerComponent({ className, ...props }: ChartContainerProps) {
...
export function ChartTooltipComponent({ className, ...props }: ChartTooltipProps) {
  return <div className={cn("", className)} {...props} />
}

export interface ChartTooltipContentProps extends React.HTMLAttributes<HTMLDivElement> {}

export function ChartTooltipContentComponent({ className, ...props }: ChartTooltipContentProps) {
...
export function ChartLegendComponent({ className, ...props }: ChartLegendProps) {
  return <div className={cn("flex flex-wrap items-center justify-center gap-4 pt-4", className)} {...props} />
}
...
export function ChartLegendItem({ color, label, className, ...props }: ChartLegendItemProps) {
  return (
